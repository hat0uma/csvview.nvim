...
---@field lnum integer? 1-indexed line number. `lnum` is used when `row_idx` is not specified.
---@field row_idx integer? 1-indexed csv row index. `row_idx` is used when `lnum` is not specified.
---
